;; Useful functions by John Wiegley
;;
;; Usage:
;;
;;   Write those lines in your .emacs:
;;   
;;     (require 'org-wiegley-ext)
;;     (add-to-list 'safe-local-variable-values '(after-save-hook . (archive-done-tasks)))
;;
;;   then, add the local variable template in the first line of the Org files you want to
;;   automatically archive (ie. all the DONE tasks & alike will go to the archive file if
;;   date exceeds 7 days.
;;   
