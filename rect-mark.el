...
(defun rm-activate-mark (&optional force)
  ...
  (if rm-mark-active
    ...
    (mapc (function make-local-variable) rm-our-local-variables)
    ...
    (mapc (function make-local-variable) rm-temporary-local-variables)
...
(defun rm-deactivate-mark ()
  ...
  (mapc (function delete-overlay) rm-overlay-list)
  (mapc (function kill-local-variable) rm-old-global-variables)
  (mapc (function kill-local-variable) rm-our-local-variables)
